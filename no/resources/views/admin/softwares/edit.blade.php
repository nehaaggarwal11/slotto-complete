...
@php
    ...
    $all_popular_casinos = \App\Casino::all();
...
<form method="POST" action="{{ route("admin.softwares.update", [$software->id]) }}" enctype="multipart/form-data">
    @method('PUT')
    @csrf
    <div class="card">
        ...
        <div class="card-body">
          {{---  <div class="form-group">
                ...
                <input id="swatches" class="form-control demo" name="bg_color" data-swatches="#ef9a9a|#90caf9|#a5d6a7|#fff59d|#ffcc80|#bcaaa4|#eeeeee|#f44336|#2196f3|#4caf50|#ffeb3b|#ff9800|#795548|#9e9e9e" value="{{ old('bg_color', $software->bg_color) }}">
            ...
            <div class="form-group">
                ...
                <input id="swatches" class="form-control demo" name="bg_image_color" data-swatches="#ef9a9a|#90caf9|#a5d6a7|#fff59d|#ffcc80|#bcaaa4|#eeeeee|#f44336|#2196f3|#4caf50|#ffeb3b|#ff9800|#795548|#9e9e9e" value="{{ old('bg_image_color', $software->bg_image_color) }}">
            ...
            <div class="form-group">
                ...
                @endphp
                <select class="form-control custom_order select2_new_slots {{ $errors->has('new_slots') ? 'is-invalid' : '' }}" name="new_slots[]" id="new_slots" data-selected="{{ implode(",", $new_slots) }}" multiple>
                    @foreach($new_slots as $game_id)
                        @php
                            /**
            ...
            <div class="form-group">
                ...
                @endphp
                <select class="form-control custom_order select2_popular_slots {{ $errors->has('popular_slots') ? 'is-invalid' : '' }}" name="popular_slots[]" id="popular_slots" data-selected="{{ implode(",", $popular_slots) }}" multiple>
                    ...
                    @endforeach
                    @foreach($all_games as $game)
                        @if($game && !in_array($game->id, $popular_slots))
                            <option value="{{ $game->id }}">{{ $game->name }} - {{$game->provider}}</option>
                        @endif
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                @endphp
                <select class="form-control custom_order select2_all_slots {{ $errors->has('all_slots') ? 'is-invalid' : '' }}" name="all_slots[]" id="all_slots" data-selected="{{ implode(",", $all_slots) }}" multiple>
            ...
            <div class="form-group">
                ...
                @php
                    $popular_casinos = explode(",", $software->popular_casinos)
                @endphp
            ...
            <div class="form-group m-b-20">
                <label class="m-b-15" for="content">{{ trans('cruds.software.fields.content') }}</label>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('faq_heading') ? 'is-invalid' : '' }}" type="text" name="faq_heading" value="{{ old('faq_heading', @$software->faq_heading) }}">
            ...
            <div class="form-group">
                <label for="faqs">{{ trans('cruds.software.fields.faq') }}</label>
                @php
                    $faqs = explode(",", $software->faqs)
                @endphp
                ...
                @endif
                <span class="help-block">{{ trans('cruds.software.fields.faq_helper') }}</span>
            </div>
