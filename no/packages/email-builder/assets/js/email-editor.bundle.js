    ...
    (function(factory) {
        ...
        EmailBuilder.prototype = {
            ...
            generate: function(elementsHtml) {
                ...
                // _nav += '<li class="menu-item menu-line " ></li>';
                //
                // _nav += '<li class="menu-item command-undo " >' +
                //     '<i class="fa fa-reply"></i>' +
                //     '<span class="menu-name">' + _this.langArr.commandUndo + '</span>' +
                //     '</li>';
                //
                // _nav += '<li class="menu-item command-redo">' +
                //     '<i class="fa fa-share"></i>' +
                //     '<span class="menu-name">' + _this.langArr.commandRedo + '</span>' +
                //     '</li>';
                ...
                if (_this.config.showSettingsBar == true) {
                    ...
                    //     </ul>
                    //     <div>
                    //       <div class="mobile-content setting-device-content ">mobile-content </div>
                    //       <div class="desktop-content setting-device-content active">desktop-content </div>
                    //     </div>
                    //   </div>
                    // </div>
                ...
                _tabElements = '<div class="tab-elements element-tab active"><ul class="elements-accordion">' + elementsHtml + '</ul></div>';
