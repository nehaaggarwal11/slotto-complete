...
class SoftwareController extends Controller
{
    ...
    public function index(Request $request, $slug)
    {
        ...
        $all_slots = $all_slots_ids ? Game::select('id', 'name', 'slug', 'logo_alt_text')
        ...
        $faq_questions = $faq_questions_ids ? FaqQuestion::select('id','question', 'answer')
            ...
            ->get(): null;      
        return view('frontend.software-game', compact('software','new_slots','popular_slots','all_slots','casinos','faq_questions'));
    }
}
