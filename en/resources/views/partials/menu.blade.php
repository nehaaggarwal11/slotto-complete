            ...
            @can('content_management_access')
                <li class="nav-item nav-dropdown">
                    ...
                    <ul class="nav-dropdown-items">
                        ...
                        @endcan
                        @can('dynamic_page_access')
                            <li class="nav-item">
                                <a href="{{ route("admin.dynamic-pages.index") }}" class="nav-link
                               {{ request()->is('admin/dynamic-pages') || request()->is('admin/dynamic-pages/*') ? 'active' : '' }}">
                                    <i class="fa-fw fas fa-folder nav-icon"></i>
                                    {{ trans('cruds.dynamicPage.title') }}
                                </a>
                            </li>
                        @endcan
                    </ul>
