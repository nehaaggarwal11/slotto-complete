                          ...
                          <tbody>
                            <tr>
                              <td style="width: 100px;border-collapse: collapse;"> 
                                <img src="{{ asset('asset/frontend/img/logo/logo2.png') }}" style="border: 0;display: block;outline: none;text-decoration: none;height: auto;width: 100%;line-height: 100%;" width="100" alt="logo">
                              </td>
                            </tr>
                          </tbody>
                        </table>
                                      ...
                                      <tr>
                                        <td align="center" style="font-size: 0px;padding: 0;border-collapse: collapse;">
                                          <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:collapse;border-spacing:0px;">
                                            <tbody>
                                              <tr>
                                                <td style="width: 600px;border-collapse: collapse;"> <img src="{{ asset('asset/frontend/img/email/man.jpg') }}" style="border: 0;border-radius: 8px 8px 0 0;display: block;outline: none;text-decoration: none;height: auto;width: 100%;line-height: 100%;" width="600" alt="header">
                                                </td>
                                              </tr>
                                            </tbody>
                                          </table>
                              ...
                              <tr>
                                <td align="center" style="font-size: 0px;padding: 0px;border-collapse: collapse;">
                                  <div style="font-family:Lato, Helvetica, sans;font-size:15px;line-height:24px;text-align:center;color:#545465;">
                                    <p style="display: block;margin: 13px 0;">{!! $email_content !!}</p><br>
                                    <div class="mj-column-per-100 outlook-group-fix" style="font-size:13px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;">
                                        <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align: top;border-collapse: collapse;" width="100%">
                                            <tr>
                                                <td align="center" style="font-size: 0px;padding: 0;border-collapse: collapse;">
                                                <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:separate;line-height:100%;">
                                                    <tr>
                                                    <td align="center" bgcolor="#586EE0" style="border: none;border-radius: 6px;padding: 10px 25px;background: #586EE0;border-collapse: collapse;" valign="middle"> <a href="{{ route('frontend.subscribers.subscribe.confirm', $email) }}" style="background:#586EE0;color:#ffffff;font-family:Lato, Helvetica, sans;font-size:15px;font-weight:bold;line-height:120%;margin:0;text-decoration:none;text-transform:none;" target="_blank">Confirm Subscription</a></td></tr></table>
                                                </td>
                                            </tr>
                                        </table>
                                    </div>
                      ...
                      <tr>
                        <td align="center" style="font-size: 0px;padding: 10px 25px;border-collapse: collapse;">
                          <div style="font-family:Lato, Helvetica, sans;font-size:12px;line-height:18px;text-align:center;color:#939DA8;">
                            <p style="display: block;margin: 13px 0;">Copyrightʩ 2020 {{ config('app.name') }}</p>
                            <p style="display: block;margin: 13px 0;">You are receiving this email because you opted in via our website.</p>
                            <p style="display: block;margin: 13px 0;"><a href="{{ route('frontend.subscribers.unsubscribe', $email) }}" style="color:#939DA8;">Unsubscribe</a>
                          </p>
                        </div>
                      </td>
                    </tr>
