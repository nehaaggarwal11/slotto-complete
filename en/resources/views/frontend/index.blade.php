...
@section('content')
    ...
    <section id="slider-section">
        <video title="parrot standing by a waterfall with a small pirate flag and treasure chest, sabel, pirate hat, and boat steering wheel" autoplay muted loop id="myVideo-desktop">
            <source src="{{ asset('asset/frontend/img/banners/casino-scenes-new.mp4')}}"
                    type="video/mp4">
        </video>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12" style="margin-bottom:40px;">
                        ...
                        <!-- <div class="row">
                            <div class="col-md-12">
                                <a class="btn btn-primary casino-view-btn mx-auto d-block" href="javascript:void(0);">Read More</a>
                            </div>
                        </div> -->
            ...
            <div class="container-fluid">
                ...
                <div class="row rating-mobile">
                    <div class="col-md-12">
                        ...
                        <!-- <button class="btn btn-primary view-btn mx-auto d-block" onclick="window.location.href='{{ route('frontend.casino-bonus') }}'">See All
                        </button> -->
                    </div>
                </div>
            </div>
    ...
    <section class="slot-machine-sec">
        ...
        <div class="container-fluid">
            ...
            <button
            class="btn btn-primary more-casino-btn mx-auto d-block" onclick="window.location.href='{{ route('frontend.all-games') }}'">Free Slots
            </button>
        </div>
    ...
    <section class="new-casino-sec section-padding" aria-label="fjell">
            ...
            <div class="row">
                <div class="col-lg-8 mx-auto">
                    <img src="{{ asset('asset/frontend/img/fishes/orange-fish.png')}}"
                         class="orange-fish" width="100" alt="a smiling fish">
                    <div class="section-title-item">
                        {{-- <h2 class="section-title">Nye online Casino
                        </h2> --}}
                        <img src="{{ asset('asset/frontend/img/gif/nye.gif')}}"
                             class="mx-auto d-block nye-img" alt="a neon sign with the text nye online casino blinking">
                    </div>
                </div>
            </div><!-- row end -->
            <div class="row">
        ...
        <button class="btn btn-primary more-casino-btn mx-auto d-block" onclick="window.location.href='{{url ('nye-casino')}}'">New Slots Sites</button>
    ...
    <section class="blog-sec">
        <div class="container">
            ...
            <a class="btn btn-primary more-blogs-btn"
                   href="{{ route('frontend.all-news') }}">More News</a>
        </div><!-- container end -->
