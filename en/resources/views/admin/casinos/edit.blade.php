...
<form method="POST" action="{{ route("admin.casinos.update", [$casino->id]) }}" enctype="multipart/form-data">
    @method('PUT')
    @csrf
    <div class="card">
        ...
        <div class="card-body">
            <div class="form-group">
                <label>{{ trans('cruds.casino.fields.slug') }}</label>
                <div class="input-group mb-3">
                    <div class="input-group-prepend">
                        <a href="{{ $casino->route }}" class="btn btn-link btn-outline-light" target="_blank">View</a>
                        <span class="input-group-text">{{ $casino->route }}</span>
                    </div>
                </div>
            ...
            <div class="form-group">
                ...
                <input id="swatches" class="form-control demo" name="bg_color" data-swatches="#ef9a9a|#90caf9|#a5d6a7|#fff59d|#ffcc80|#bcaaa4|#eeeeee|#f44336|#2196f3|#4caf50|#ffeb3b|#ff9800|#795548|#9e9e9e" value="{{ old('bg_color', $casino->bg_color) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('link') ? 'is-invalid' : '' }}" type="text" name="link" id="link" value="{{ old('link', $casino->link) }}">
                @if($errors->has('link'))
                    <div class="invalid-feedback">
                        {{ $errors->first('link') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('small_description') ? 'is-invalid' : '' }}" type="text" name="small_description" id="small_description" value="{{ old('small_description', $casino->small_description) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('wagering_requirements_text') ? 'is-invalid' : '' }}" type="text" name="wagering_requirements_text" id="wagering_requirements_text" value="{{ old('wagering_requirements_text', $casino->wagering_requirements_text) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('detail') ? 'is-invalid' : '' }}" name="detail" id="detail">{!! old('detail', $casino->detail) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('featured_image_alt_text') ? 'is-invalid' : '' }}" type="text" name="featured_image_alt_text" id="featured_image_alt_text" value="{{ old('featured_image_alt_text', $casino->featured_image_alt_text) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('logo_image_alt_text') ? 'is-invalid' : '' }}" type="text" name="logo_image_alt_text" id="logo_image_alt_text" value="{{ old('logo_image_alt_text', $casino->logo_image_alt_text) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('transparent_logo_image_alt_text') ? 'is-invalid' : '' }}" type="text" name="transparent_logo_image_alt_text" id="transparent_logo_image_alt_text" value="{{ old('transparent_logo_image_alt_text', $casino->transparent_logo_image_alt_text) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('bg_image_alt_text') ? 'is-invalid' : '' }}" type="text" name="bg_image_alt_text" id="bg_image_alt_text" value="{{ old('bg_image_alt_text', $casino->bg_image_alt_text) }}">
