    ...
    <table class="table table-rating nj_sorting_table">
        <thead>
            <tr>
                ...
                <th>Wagering Req <i class="fa fa-sort" aria-hidden="true"></i></th>
            ...
            @foreach($casinos as $cas => $casino)
                <tr>
                    ...
                    <td data-order="{{ $casino->bonus }}" align="center" style="width:200px;">
                        <a href="{{ $casino->link }}"><h6>{{ $casino->name }}</h6></a>
                        ...
                        @endif
                        <a href="{{ $casino->route }}">
                            <p class="add-review-btn">Read Review</p>
                        </a>
                    </td>
                    ...
                    <td>
                        <a href="{{ $casino->link }}" target="_blank" class="btn blue text-nowrap">Play Here
                        </a>
                    </td>
                </tr>
            @endforeach
