                    ...
                    <div class="col-md-8 offset-md-2 pull-md-2">
                        ...
                        <div class="play-game-content">
                            ...
                            <div class="play-game-list mobile-game-table d-lg-none d-xl-none">
                                <p>RTP (Return To Player) <span>{{$games->rtp_game}}</span></p>
                                <p>Layout <span>{{$games->layout}}</span></p>
                                <p>Paylines <span>{{$games->gevinstlinjer}}</span></p>
                                <p>Max coin win <span>{{$games->maks_mynt_gevinst}}</span></p>
                                <p>Volatility <span>{{$games->volatilitet_game}}</span></p>
                                <p>Min. stake <span>{{$games->min_innsats}}</span></p>
                                <p>Maks stake <span>{{$games->maks_innsats}}</span></p>
                            </div>
                            {!! $games->description !!}
