        ...
        <div class="container">
                        ...
                        <div class="first-casino-banner position-absolute">
                            <div class="first-casino-banner-img">
                                <div class="first-casino-banner-logo">
                                    ...
                                    <a href="{{ @$tmc_casinos[0]->route }}" class="read-review">Read Review</a>
                                </div>
                            </div>
                            ...
                            <div class="review-casino-btn">
                                <button class="btn-primary claim-btn mx-auto d-block" onclick="window.location.href = '{{ @$tmc_casinos[0]->link }}'">Get The Bonus</button>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="second-casino-banner position-absolute">
                            <div class="second-casino-banner-img">
                                <div class="second-casino-banner-logo">
                                    ...
                                    <a href="{{ @$tmc_casinos[1]->route }}" class="read-review">Read Review</a>
                                </div>
                            </div>
                            <div class="casino-bonus">
                            ...
                            <div class="review-casino-btn">
                                <button class="btn-primary claim-btn mx-auto d-block" onclick="window.location.href = '{{ @$tmc_casinos[1]->link }}'">Get The Bonus</button>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row rating-mobile mt-4 d-block d-lg-none d-xl-none">
                <div class="col-md-12">
                    ...
                    <button class="btn btn-primary view-btn mx-auto d-block">See All
                    </button>
                </div>
            </div>
        </div>
