...
<section id="site-map-section">
    <div class="container">
        ...
        <div class="row mt-4">
            ...
            <div class="col-md-3">
                <h3>Pages</h3>
                <p><a href="{{ route('frontend.page.about-us') }}" target="_blank">About Us</a></p>
                <p><a href="{{ route('frontend.faq')}}" target="_blank">FAQ</a></p>
                <p><a href="{{ route('frontend.page.responsible-gaming')}}" target="_blank">Responsible Gaming</a></p>
                <p><a href="{{ route('frontend.page.general-information')}}" target="_blank">General Information</a></p>
                <p><a href="{{ route('frontend.page.privacy-policy')}}" target="_blank">Privacy Policy</a></p>
                <p><a href="{{ route('frontend.page.terms')}}" target="_blank">Terms & Condition</a></p>
                <p><a href="{{ route('frontend.page.cookies')}}" target="_blank">Cookies</a></p>
            </div>
        </div>
    </div>
</section>
