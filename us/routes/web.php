...
Route::group(['as' => 'frontend.', 'namespace' => 'Frontend'], function () {
    ...
    Route::get('/all-games', 'AllGameController@index')->name('all-games');
    Route::get('/all-games/search', 'AllGameController@search')->name('all-games.search');
    Route::get('/game/{id}/{slug}', 'GameController@index')->name('game');
    Route::get('/all-news', 'AllNewsController@index')->name('all-news');
    Route::get('/all-news/search', 'AllNewsController@search')->name('all-news.search');
